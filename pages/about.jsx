      ...
      <div className={styles.about__intro}>
        <div className={styles.introText}>
          ...
          <p>
            ...
            the train station, feel free to contact us and arrange a visit. Our
            well stocked showroom is ready for you to come browse your next
            potential bike. Offering a range of new and used motorcycles such as
            Honda, Ducati, BMW, Triumph, MV Augusta, Lexmoto, Yamaha, Kawasaki &
            KTM. We also offer a range of accessories from notable brands such
            as Alpinestar, Muc-Off, HJC, Oxford Products, and MT Helmets.
          </p>
        </div>
